                ...
                <div className="contain_onglet">
                    <ul className="footer_onglet-list">
                        <li className="nav-item" >
                            <NavLink className="nav-link" to="/user/LeFrontDeMer">Accueil </NavLink>
                            <div className="hover_nav"></div>
                        </li>
                        <li className="nav-item" >
                            <NavLink className="nav-link" to="/user/Carte">Notre carte </NavLink>
                            <div className="hover_nav"></div>
                        </li>
                        <li className="nav-item" >
                        ...
                        <li className="nav-item" >
                            <NavLink className="nav-link" to="/user/Apropos">A propos </NavLink>
                            <div className="hover_nav"></div>
                        </li>
                        <li className="nav-item" >
                            <NavLink className="nav-link" to="/user/Confidentialites">Confidentialité </NavLink>
                            <div className="hover_nav"></div>
                        </li>
                        <li className="nav-item" >
                            <NavLink className="nav-link" to="/user/Contact">Contact</NavLink>
                            <div className="hover_nav"></div>
                        </li>
                    ...
                    <div className="info_social">
                        ...
                        <div className="title_container">
                            ...
                            <div className="footer_logo" >
                                <NavLink to="/user/LeFrontDeMer" className="footer_img"><img src={LogoNav} className="twitter_link" title="twiter" alt="pinceau decoratif" /></NavLink>
                            </div>
