    ...
    return (
        <div className="NavBarContainer">
            ...
            <div className="container_top">
                ...
                <div className="container_left">
                    <div className="container-img">
                        <NavLink className="navbar-brand" to="/LeFrontDeMer">
                ...
                <div className="container_identification">
                    <NavLink className="btn_link" to="/SeConnecter">Connexion</NavLink>
                    <NavLink className="btn_link" to="/Sinscrire">Inscription</NavLink>
                </div>
            </div>
            ...
            <div className="container_reservation">
                <NavLink className="reservation" to="/SeConnecter">Réserver en ligne</NavLink>
            </div>
